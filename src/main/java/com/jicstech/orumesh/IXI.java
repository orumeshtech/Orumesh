...
import com.jicstech.orumesh.service.CallableRequest;
...
public class IXI {
    ...
    private static final ScriptEngine scriptEngine = (new NashornScriptEngineFactory()).getScriptEngine((classname) ->
            !"com.oruMesh.OruMesh.IXI".equals(classname));
    */
    ...
    private final OruMesh oruMesh;

    public IXI() {
        oruMesh = null;
    }
    public IXI(OruMesh oruMesh) {
        this.oruMesh = oruMesh;
    }
